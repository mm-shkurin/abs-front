            ...
            <div className="conteiner">
                <div className="first-content">
                    <div className="txt-content">
                        <h1>О НАС</h1>
                        <p>Добро пожаловать в Absolute ! Мы предлагаем широкий выбор новых и подержанных автомобилей высочайшего качества. Наша цель - обеспечить вас непревзойденным сервисом и помочь вам найти идеальное авто. Доверьте нам свои мечты о автомобиле, и мы сделаем все возможное, чтобы они стали реальностью.
                        </p>
                    </div>
